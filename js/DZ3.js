...
//який перевіряє чи містить змінна email символ @ і рахує загальну кількість символів. Результат виведіть в консоль.
...
// За допомогою шаблонного рядка виведіть на екран через alert повідомлення на прикладі цього: «Дякуємо, Олександро!
// До сплати 300 гривень»
const userName = prompt("Введіть ваше ім'я:")
const payment = "300грн"
alert("«" + "Дякуємо," + " " + userName + "!" + " " + "До" + " " + "оплати" + " " + payment + "»")